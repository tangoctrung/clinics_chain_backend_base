...
var file_mailservice_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mailservice_proto_goTypes = []interface{}{
	(*NewUser)(nil), // 0: mailservice.NewUser
	(*User)(nil),    // 1: mailservice.User
}
var file_mailservice_proto_depIdxs = []int32{
	0, // 0: mailservice.PostUser.CreateNewUser:input_type -> mailservice.NewUser
	1, // 1: mailservice.PostUser.CreateNewUser:output_type -> mailservice.User
