...
var file_staffservice_proto_goTypes = []interface{}{
	(*NewUser)(nil), // 0: staffservice.NewUser
	(*User)(nil),    // 1: staffservice.User
}
var file_staffservice_proto_depIdxs = []int32{
	0, // 0: staffservice.PostUser.CreateNewUser:input_type -> staffservice.NewUser
	1, // 1: staffservice.PostUser.CreateNewUser:output_type -> staffservice.User
